...
export default function ProfilePage() {
    ...
    return (
     ...
     <button style={{background:"gray",color:"white"}}>  Write my story after my death.
        ...
        <button style={{background:"gray",color:"white"}}>To achieve your dreams, work hard and try till your last breath..! <br />
...
<button style={{background:"gray",color:"white"}}>Relationships often end due to misunderstandings <br />
...
<button style={{background:"gray",color:"white"}}> Can't see two hearts meeting <br /> <br />

People even drive away two sitting birds💔💔</button>
<button style={{background:"gray",color:"white"}}> Listen, you make me cry every day <br />

Don't you feel pain from someone else's pain? 🤔 <br />
    Those who dwell in the heart 🥀<br />

They are the ones who disturb sleep 😔💔 </button>
<button style={{background:"gray",color:"white"}}> When I had to say goodbye💔 <br />
